    ...
    return (
        <Section title='News' subtitle='Hanon×Kotoha×HoneyWorks「Winter Vox」通販開始のお知らせ' isBack={true}>
            ...
            <div className="text-primary-500/80 mt-14 leading-8 font-japanese text-md">
                ...
                <p><br />▼収録楽曲：<br />M1：「厭わない feat. 富田美憂,市ノ瀬加那」<br />※TVアニメ 『あやかしトライアングル』エンディングテーマ<br />M2：「とけない feat.EMA」<br />M3：「褪せない feat.りりあ。」<br />M4：「足りない feat.Kotoha」<br />M5：「厭わない feat. 富田美憂,市ノ瀬加那 -TV version-」<br />※期間生産限定盤のみに収録</p><br />
                <p>▼グッズ詳細はこちら▼<br /></p>
                <img src='https://hakoniwalily.jp/cms/wp-content/uploads/2022/11/S__19300588-768x1279.jpg' className='my-10' />
                <p>※以下商品につきましては個数制限を設けさせていただきます。<br />
                    ・はのこと、こともちペンライト　お1人様各5個ずつまで<br />
                    ・『Lily’s Plage』らんだむ缶バッジ　お1人様10個まで</p>
            </div>
        </Section>
    )
}
